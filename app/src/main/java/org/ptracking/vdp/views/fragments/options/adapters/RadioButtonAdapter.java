...
public class RadioButtonAdapter extends CheckableOptionsAsListAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh.setRadioButtonClickListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (!onBind) {
                    CheckableOptionsAsListUIData.SingleDataOption singleDataOption = (CheckableOptionsAsListUIData.SingleDataOption) compoundButton.getTag();
                    for (CheckableOptionsAsListUIData.SingleDataOption o : optionsUIData.getSingleDataOptionArrayList()) {
                        o.setSelected(false);
                    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final CheckableOptionsAsListUIData.SingleDataOption singleDataOption = optionsUIData.getSingleDataOptionArrayList().get(position);
