...
public class SurveyListPresenter implements Contract.UserAction {
    ...
    @Override
    public void deleteSnapshot(SurveyListData surveyListData) {
        callback.showLoading(R.string.deleting);
        ...
        snapshotIO.delete()
                ...
                .subscribe(new Consumer<Boolean>() {
                    ...
                    public void accept(Throwable throwable) throws Exception {
                        Timber.e("Error while deleting survey file " + throwable.getMessage());
                        callback.hideLoading();
                        callback.onError(R.string.error_deleting_file);
                    }
                });
    }

    @Override
    public void getSurveyData(final SurveyListData surveyListData) {
            ...
            snapshotIO.read()
                    ...
                    .subscribe(new Consumer<Survey>() {
                        ...
                        public void accept(Throwable throwable) throws Exception {
                            ...
                            callback.showSnapshotDeleteDialog(surveyListData);
                        }
                    });
        } else {
